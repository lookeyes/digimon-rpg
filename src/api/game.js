...
export async function getPlayerInfo() {
  ...
  return { objectId:user.objectId, username:user.username, playerName:user.playerName||user.username, gold:user.gold??10000, items:user.items||'{}', cards:user.cards||'{}', presets:user.presets||null, activePreset:user.activePreset??0 }
}
