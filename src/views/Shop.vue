...
const shopItems=[{id:'heal_hp',icon:'💚',name:'回复药剂',desc:'回复40%HP',price:200},{id:'heal_mp',icon:'💎',name:'MP回复剂',desc:'回复35%MP',price:200},{id:'antidote',icon:'🌿',name:'解毒草',desc:'治愈中毒',price:100},{id:'awakening',icon:'💤',name:'苏醒药',desc:'治愈睡眠',price:150},{id:'burn_heal',icon:'🔥',name:'灼烧膏',desc:'治愈灼烧',price:100},{id:'ice_heal',icon:'❄️',name:'解冻剂',desc:'治愈冰冻',price:100},{id:'para_heal',icon:'⚡',name:'解麻药',desc:'治愈麻痹',price:100},{id:'confuse_heal',icon:'🌀',name:'解乱果',desc:'治愈混乱',price:100},{id:'full_heal',icon:'🏥',name:'万能药',desc:'治愈全部异常',price:500},{id:'revive',icon:'✨',name:'复活药',desc:'复活+回复30%HP',price:800},{id:'elixir',icon:'🍀',name:'圣灵药',desc:'回复25%HP+MP',price:500}]
const specialItems=[{id:'name_tag',icon:'🏷️',name:'改名卡',desc:'给一只数码兽改名',price:300},{id:'free_reset',icon:'🔁',name:'洗点券',desc:'重置已分配自由点',price:500},{id:'nature_mint',icon:'🌿',name:'性格薄荷',desc:'随机改变性格',price:800}]
