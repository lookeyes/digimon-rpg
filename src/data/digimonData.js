...
export const digimonTemplates = [
  { id:'agumon',name:'亚古兽',stage:'成长期',fields:['nature_spirits','dragons_roar'],type:'疫苗',description:'爬虫类型的数码宝贝，必杀技是从口中吐出火焰弹「小型火焰」。',baseHp:110,baseMp:40,baseAtk:30,baseDef:20,baseSpAtk:25,baseSpDef:18,baseSpd:18,growthHp:'B',growthMp:'C',growthAtk:'A',growthDef:'B',growthSpAtk:'B',growthSpDef:'C',growthSpd:'B',abilities:['dragon_will','flame_power'],evolutionTree:[{name:'暴龙兽',stage:'成熟期',method:'level',condition:16,fields:['dragons_roar','nature_spirits'],type:'疫苗',fieldExpRequired:{dragons_roar:50}},{name:'丧尸暴龙兽',stage:'成熟期',method:'item',condition:'dark_gear',fields:['dark_area','dragons_roar'],type:'病毒',fieldExpRequired:{dark_area:50}}] },
...
export const evoChains = {
  '暴龙兽':[{name:'机械暴龙兽',stage:'完全体',method:'level',condition:32,fields:['dragons_roar','metal_empire'],type:'疫苗',fieldExpRequired:{dragons_roar:150,metal_empire:50}}],
